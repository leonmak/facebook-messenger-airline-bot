  ...
  if(announceMsg) {
    ...
    Object.keys(sessions).forEach(k => {
      ...
      if (announceMsg.posttype == "flightdelay") {
        ...
        FB.newMessage(sessionObj.fbid, "Welcome "+ sessionObj.context.passengerData.fullName+" to Singapore Airlines. Anytime you need assistance from our flight attendants, please type 'Req: <Your Request>'");;
      } else if (announceMsg.posttype == "endflight") {
        const quickreplies =[{"content_type":"text","title":"Leave feedback.","payload":"I would like to leave some feedback."}]
        FB.newMessage(sessionObj.fbid, "We have reached your destination. Your luggage has arrived and is at belt 32. Have a great trip! We would appreciate it a lot if you can leave us some feedback.", null, quickreplies);
      }
    })
